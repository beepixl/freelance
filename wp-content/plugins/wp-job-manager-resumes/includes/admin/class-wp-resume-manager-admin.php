...
class WP_Resume_Manager_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'resume_manager_admin_js', RESUME_MANAGER_PLUGIN_URL. '/assets/js/admin.min.js', array( 'jquery', 'jquery-tiptip', 'jquery-ui-datepicker' ), RESUME_MANAGER_VERSION, true );
	}
