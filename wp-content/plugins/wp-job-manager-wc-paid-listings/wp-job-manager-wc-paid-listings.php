...
// Define constants
define( 'JOB_MANAGER_WCPL_VERSION', '2.1.3' );
...
function wp_job_manager_wcpl_init() {
	...
	class WP_Job_Manager_WCPL {
		...
		public function __construct() {
			...
			include_once( 'includes/class-wp-job-manager-wcpl-package.php' );
...
";
    ...
    // Upgrades
    if ( version_compare( get_option( 'wcpl_db_version', 0 ), '2.1.2', '<' ) ) {
