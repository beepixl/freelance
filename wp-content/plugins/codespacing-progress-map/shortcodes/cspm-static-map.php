									...
									tilesloaded: function(){
										...
										setTimeout(function(){
											if(json_markers_data.length > 0 && show_infobox == 'true')
												cspm_draw_multiple_infoboxes(plugin_map, map_id, '<?php echo $CspmMainMap->cspm_infobox(esc_attr($infobox_type), 'multiple', 'static_'.$map_id, 'false', $infobox_link_target); ?>', infobox_type, 'no');
										}, 1000);					
