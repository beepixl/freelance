...
<ul class="actions">
	...
	<?php if ( $attachments = get_job_application_attachments( $application->ID ) ) : ?>
		<?php foreach ( $attachments as $attachment ) : ?>
			<li class="attachment"><a href="<?php echo esc_attr( $attachment ); ?>" title="<?php echo esc_attr( get_job_application_attachment_name( $attachment ) ); ?>" class="job-application-attachment"><?php echo esc_html( get_job_application_attachment_name( $attachment, 20 ) ); ?></a></li>
		<?php endforeach; ?>
	<?php endif; ?>
